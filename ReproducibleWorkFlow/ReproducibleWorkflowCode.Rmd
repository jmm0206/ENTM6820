...
## Analysis
Treatment did have a significant effect on the total number of CMBS on the crape myrtles (p=0.0006). Limonene is not significantly different from dinotefuran or water but is the only of those treatments that is significantly different from the other treatments (imidacloprid, pyriproxyfen, and control).
```{r}
library(ggplot2)
